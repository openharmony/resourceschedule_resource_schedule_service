...
ResSchedHiTraceChain::ResSchedHiTraceChain(const bool isClearId, const char *name)
{
    if (isClearId) {
        HiTraceChainClearId();
        isBegin_ = true;
...
ResSchedHiTraceChain::ResSchedHiTraceChain(const char *name, const int32_t flags)
{
...
ResSchedHiTraceChain::~ResSchedHiTraceChain()
{
    if (isBegin_) {
