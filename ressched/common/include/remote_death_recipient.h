...
#ifndef RESSCHED_COMMON_INCLUDE_REMOTE_DEATH_RECIPIENT_H
#define RESSCHED_COMMON_INCLUDE_REMOTE_DEATH_RECIPIENT_H
...
#endif  // RESSCHED_COMMON_INCLUDE_REMOTE_DEATH_RECIPIENT_H