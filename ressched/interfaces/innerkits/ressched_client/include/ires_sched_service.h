...
public:
     ...
     */
    virtual void RegisterSystemloadNotifier(const std::string& cbType, const sptr<IRemoteObject>& notifier) = 0;
     ...
     * @param cbType callback type string
     */
    virtual void UnRegisterSystemloadNotifier(const std::string& cbType) = 0;
