...
#ifndef RESSCHED_SCHED_CONTROLLER_OBSERVER_INCLUDE_AUDIO_RENDER_STATE_OBSERVER_H
#define RESSCHED_SCHED_CONTROLLER_OBSERVER_INCLUDE_AUDIO_RENDER_STATE_OBSERVER_H
