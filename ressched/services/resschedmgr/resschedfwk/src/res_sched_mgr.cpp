...
namespace {
    static const std::map<uint32_t, std::string> resTypeToStr = {
        ...
        { ResType::RES_TYPE_PROCESS_QOS_CHANGE, "PROCESS_QOS_CHANGE" },
        ...
        { ResType::SYNC_RES_TYPE_APP_IS_IN_TAIHANG_LIST, "SYNC_RES_TYPE_APP_IS_IN_TAIHANG_LIST" },
        ...
        { ResType::RES_TYPE_COMPONENT_STATE_CHANGE, "RES_TYPE_COMPONENT_STATE_CHANGE" },
        { ResType::RES_TYPE_FLOAT_START_FROM_SIDEBAR, "RES_TYPE_FLOAT_START_FROM_SIDEBAR"},
        { ResType::SYNC_RES_TYPE_DFX_CTRL_IMAGE_INTERFACE, "SYNC_RES_TYPE_DFX_CTRL_IMAGE_INTERFACE"},
        ...
        { ResType::RES_TYPE_CTRL_FORKALL_IMAGE_INTERFACE, "RES_TYPE_CTRL_FORKALL_IMAGE_INTERFACE" },
        { ResType::RES_TYPE_CREATE_LIVING_APP_PROCESS, "RES_TYPE_CREATE_LIVING_APP_PROCESS" },
        { ResType::RES_TYPE_IMAGE_PROCESS_STATE_CHANGED, "RES_TYPE_IMAGE_PROCESS_STATE_CHANGED" },
        { ResType::SYNC_RES_TYPE_GET_IS_TEMPLATE_PROCESS, "SYNC_RES_TYPE_GET_IS_TEMPLATE_PROCESS" },
        { ResType::RES_TYPE_SNAPSHOT_FAILURE, "RES_TYPE_SNAPSHOT_FAILURE" },
        { ResType::SYNC_RES_TYPE_FORKALL_CONFIG_CHANGE, "SYNC_RES_TYPE_FORKALL_CONFIG_CHANGE" },
        { ResType::RES_TYPE_INPUT_METHOD_CHANGE, "RES_TYPE_INPUT_METHOD_CHANGE" },
        { ResType::SYNC_RES_TYPE_GET_UI_NODE_GC_CONFIG, "SYNC_RES_TYPE_GET_UI_NODE_GC_CONFIG" },
        { ResType::SYNC_RES_TYPE_NOTIFY_MAKE_IMAGE, "SYNC_RES_TYPE_NOTIFY_MAKE_IMAGE" },
        { ResType::RES_TYPE_NEARLINK_SERVICE_EVENT, "RES_TYPE_NEARLINK_SERVICE_EVENT" },
        { ResType::RES_TYPE_REPORT_NFC_SIGNAL, "RES_TYPE_REPORT_NFC_SIGNAL" },
        { ResType::RES_TYPE_DISTRIBUTED_CONTINUATION_EVENT, "RES_TYPE_DISTRIBUTED_CONTINUATION_EVENT" },
        { ResType::RES_TYPE_BGTASK_ADJUST_EVENT, "RES_TYPE_BGTASK_ADJUST_EVENT" },
    };
