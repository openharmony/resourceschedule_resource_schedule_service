...
namespace {
    const std::string SOCPERF_RESOURCE_CONFIG_XML = "etc/socperf/socperf_resource_config.xml";
    const std::string SOCPERF_BOOST_CONFIG_XML    = "etc/socperf/socperf_boost_config.xml";
    const std::string SOCPERF_POWER_CONFIG_XML    = "etc/socperf/socperf_power_config.xml";
    const std::string SOCPERF_THERMAL_CONFIG_XML  = "etc/socperf/socperf_thermal_config.xml";
